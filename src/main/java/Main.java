...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        double optAvg = optTotal / times;
        double fifoAvg = fifoTotal / times;
        double lruAvg = lruTotal / times;
        System.out.println("-Averages-");
        System.out.println("Optimal : " + Math.round(optAvg * 1000.0) / 1000.0);
        System.out.println("FIFO : " + Math.round(fifoAvg * 1000.0) / 1000.0);
        System.out.println("LRU : " + Math.round(lruAvg * 1000.0) / 1000.0);
